...
$all_portfolios_query = "SELECT * FROM portfolios WHERE id='$id'";
$all_portfolios_from_db = mysqli_query($db_connect,$all_portfolios_query);
$after_assoc = mysqli_fetch_assoc($all_portfolios_from_db);
?>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="images/portfolio_images/feature_images/<?=$after_assoc['portfolio_feature_photo']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?= $after_assoc['portfolio_tite']?></h2>
